...
def get_config_ds():
    cli_conf = OmegaConf.from_cli()
    main_yaml_conf = OmegaConf.load(cli_conf.config)
    conf = OmegaConf.merge(main_yaml_conf, cli_conf)
    # ds_conf = OmegaConf.load(cli_conf.deepspeed)
    return conf, cli_conf.deepspeed
